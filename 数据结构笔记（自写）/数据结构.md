...
![](picture/数据结构（头指针）.png)

头结点——在第一个结点之前设的结点（数据域可以为空或者存储有关链表的信息,可以没有）![](picture/头结点.png)

![总括图](picture/链表指针.png)
...
完全二叉树：![](picture/二叉树（三）.png)

不是完全二叉树：![](picture/二叉树（二）.png)
...
宗旨，左孩子还是双亲的左孩子，但右兄弟会变成右孩子（兄弟不就是孩子吗🥰🥰🥰）![](picture/树-二叉树.png)

**森林转二叉树：**

方法：森林中的每一棵树先转为二叉树，然后不同树的根以兄弟关系自居，也就是右孩子![](picture/森林-二叉树.png)

**二叉树转树：**

显然就是一个逆过程

方法：二叉树的右孩子是树中的右兄弟![](picture/二叉树-树.png)

**二叉树转森林：**

逆过程，方法：根节点有右孩子就是森林

先将森林断成树再将每一棵二叉树转树即可![](picture/二叉树-森林.png)
...
强连通分量：有向图中的极大连通子图![](picture/强连通分量.png)
...
有向图如果想同时直到入度出度，可以引入**逆邻接表**![](picture/逆邻接表.png)
